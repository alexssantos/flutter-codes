class Event {
	//Card itens
	final String imagePath, title, location, duration;
	//page itens
	final String punchLine1, punchLine2, description;
...
final fiveKmRunEvent = Event(
	imagePath: "assets/event_imgs/5_km_downtown_run.jpeg",
...
final cookingEvent = Event(
	imagePath: "assets/event_imgs/granite_cooking_class.jpeg",
...
final musicConcert = Event(
	imagePath: "assets/event_imgs/music_concert.jpeg",
...
final golfCompetition = Event(
	imagePath: "assets/event_imgs/golf_competition.jpeg",
